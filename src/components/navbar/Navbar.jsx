...
import { useAuth } from "../../context/authContext";
import { GetUser } from "../../services/user/GetUser";
import { getNotifications, markAllNotificationsAsRead } from "../../services/traveler/Traveler";
        ...
        {isLoggedIn ? (
          <li className="profile-dropdown">
            <button onClick={toggleDropdownI} className="notification-button">
              <div className="notification">
                <i className="fa-regular fa-bell"></i>
                <p className="notification-count">{unreadNotifications.length}</p>
              </div>
            </button>
            <button onClick={toggleDropdown} className="profile-button">
              <Profile />
            ...
            {dropdownVisible && (
              <div className="dropdown-menu-profile">
                <ul>
                  ...
                  {["Traveller", "EventPlanner", "Admin"].includes(
                    userRole
                  ) && (
                    <li
                      onClick={() => {
